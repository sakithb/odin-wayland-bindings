...
xdg_wm_base_add_listener :: proc(xdg_wm_base: ^Xdg_Wm_Base, implementation: ^Xdg_Wm_Base_Listener, data: rawptr) -> i32 {
...
xdg_wm_base_create_positioner :: proc(
    xdg_wm_base: ^Xdg_Wm_Base,
) -> (id: /*  */ ^Xdg_Positioner) {
    id = cast(^Xdg_Positioner)proxy_marshal_flags(
        cast(^Proxy)xdg_wm_base,
        1,
...
xdg_wm_base_get_xdg_surface :: proc(
    ...
    id = cast(^Xdg_Surface)proxy_marshal_flags(
        cast(^Proxy)xdg_wm_base,
        2,
...
xdg_positioner_add_listener :: proc(xdg_positioner: ^Xdg_Positioner, implementation: ^Xdg_Positioner_Listener, data: rawptr) -> i32 {
    return proxy_add_listener(
...
xdg_positioner_destroy :: proc(
    ...
    proxy_marshal_flags(
        ...
        0,
        nil,
        proxy_get_version(cast(^Proxy)xdg_positioner),
        {},
    )
    return
}
...
xdg_positioner_set_anchor_rect :: proc(
    xdg_positioner: ^Xdg_Positioner,
...
xdg_positioner_set_anchor :: proc(
    xdg_positioner: ^Xdg_Positioner,
    // anchor 
    anchor: uint,
){
...
xdg_positioner_set_gravity :: proc(
    xdg_positioner: ^Xdg_Positioner,
    // gravity direction 
    gravity: uint,
){
...
xdg_positioner_set_constraint_adjustment :: proc(
    xdg_positioner: ^Xdg_Positioner,
...
xdg_positioner_set_offset :: proc(
    xdg_positioner: ^Xdg_Positioner,
...
xdg_positioner_set_reactive :: proc(
    xdg_positioner: ^Xdg_Positioner,
){
    proxy_marshal_flags(
        cast(^Proxy)xdg_positioner,
...
xdg_positioner_set_parent_size :: proc(
    xdg_positioner: ^Xdg_Positioner,
...
// constrained using. 
xdg_positioner_set_parent_configure :: proc(
    xdg_positioner: ^Xdg_Positioner,
...
xdg_surface_add_listener :: proc(xdg_surface: ^Xdg_Surface, implementation: ^Xdg_Surface_Listener, data: rawptr) -> i32 {
    return proxy_add_listener(
...
xdg_surface_get_toplevel :: proc(
    ...
    id = cast(^Xdg_Toplevel)proxy_marshal_flags(
        cast(^Proxy)xdg_surface,
        1,
...
xdg_surface_get_popup :: proc(
    ...
    id = cast(^Xdg_Popup)proxy_marshal_flags(
        cast(^Proxy)xdg_surface,
        2,
        &xdg_popup_interface,
        proxy_get_version(cast(^Proxy)xdg_surface),
...
// invalid_size error. 
xdg_surface_set_window_geometry :: proc(
    xdg_surface: ^Xdg_Surface,
    //  
    x: int,
    //  
...
xdg_toplevel_add_listener :: proc(xdg_toplevel: ^Xdg_Toplevel, implementation: ^Xdg_Toplevel_Listener, data: rawptr) -> i32 {
    return proxy_add_listener(
...
xdg_toplevel_destroy :: proc(
    ...
    proxy_marshal_flags(
        ...
        0,
        nil,
        proxy_get_version(cast(^Proxy)xdg_toplevel),
        {},
    )
    return
}
...
xdg_toplevel_show_window_menu :: proc(
    xdg_toplevel: ^Xdg_Toplevel,
...
// invalid_size error. 
xdg_toplevel_set_max_size :: proc(
    xdg_toplevel: ^Xdg_Toplevel,
    //  
    width: int,
    //  
...
// invalid_size error. 
xdg_toplevel_set_min_size :: proc(
    xdg_toplevel: ^Xdg_Toplevel,
    //  
    width: int,
    //  
...
xdg_toplevel_set_maximized :: proc(
    xdg_toplevel: ^Xdg_Toplevel,
){
    proxy_marshal_flags(
        cast(^Proxy)xdg_toplevel,
...
// effect. It may alter the state the surface is returned to when 
// unmaximized unless overridden by the compositor. 
xdg_toplevel_unset_maximized :: proc(
    xdg_toplevel: ^Xdg_Toplevel,
){
    proxy_marshal_flags(
        cast(^Proxy)xdg_toplevel,
...
xdg_toplevel_set_fullscreen :: proc(
    xdg_toplevel: ^Xdg_Toplevel,
    //  
    output: ^Output,
){
...
xdg_toplevel_unset_fullscreen :: proc(
    xdg_toplevel: ^Xdg_Toplevel,
){
    proxy_marshal_flags(
        cast(^Proxy)xdg_toplevel,
...
xdg_toplevel_set_minimized :: proc(
    xdg_toplevel: ^Xdg_Toplevel,
){
    proxy_marshal_flags(
        cast(^Proxy)xdg_toplevel,
...
xdg_popup_add_listener :: proc(xdg_popup: ^Xdg_Popup, implementation: ^Xdg_Popup_Listener, data: rawptr) -> i32 {
    return proxy_add_listener(
...
xdg_popup_destroy :: proc(
    ...
    proxy_marshal_flags(
        ...
        0,
        nil,
        proxy_get_version(cast(^Proxy)xdg_popup),
        {},
    )
    return
}
